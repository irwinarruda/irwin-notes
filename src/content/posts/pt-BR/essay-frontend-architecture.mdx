...
Na prática, entretanto, ambas ferem os conceitos da arquitetura limpa. As regras de negócio são criadas em hooks, estruturas intrinsecamente ligadas ao framework, fazendo com que a camada de Aplicação conheça a interface. Testar esses hooks, por exemplo, exige um runner que implemente os ciclos de vida do React. Por causa disso, decidi continuar procurando.
